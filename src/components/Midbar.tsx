...
const Midbar: React.FC = () => {
    return(
        <div className="w-full bg-white/90 my-8 py-4 px-4">
            <div className="flex flex-col gap-3 md:grid md:grid-cols-4 md:justify-items-center max-w-screen-lg mx-auto ">
                <div className="flex items-center font-bold uppercase text-2xl">Que nos hace los mejores?</div>
                <div className="flex items-center md:justify-center gap-1 border-b-2 md:border-b-0 pb-2 w-full text-center md:border-l-2">
