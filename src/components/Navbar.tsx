...
const Navbar = () => {
  ...
  return (
    <div className='bg-primary-900 h-20 mx-auto flex justify-between items-center p-4'>
        {/* Left */}
        <Link href='/' className='flex items-center gap-6'> 
            <img src='https://res.cloudinary.com/dnqmez68n/image/upload/v1684327373/logo_o98vxm.png' alt="logo-cicec" className='h-20 w-auto' />
        </Link>
            <div className='hidden md:flex items-center cursor-pointer font-medium gap-4 p-1'>
                <Link href='/tienda' className='border-b-2 border-transparent  hover:text-secondary-100 text-secondary-200 ease-in duration-300'>Tienda</Link>
            </div>
